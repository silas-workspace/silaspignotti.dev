...
export const technologies: Technologies = {
  ...
  'AI & Dev Tools': [
    { text: 'LangChain', logo: 'lucide:workflow' },
    { text: 'LangGraph', logo: 'lucide:workflow' },
    { text: 'LiteLLM', logo: 'lucide:bot' },
    { text: 'Claude Code', logo: 'lucide:code' },
    { text: 'OpenCode', logo: 'lucide:code' },
  ...
  'Infrastructure & Tooling': [
    ...
    { text: 'Prefect', logo: 'lucide:workflow' },
    { text: 'MLflow', logo: 'lucide:workflow' },
  ],
}
